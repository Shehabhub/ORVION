...
- **Delegation is Earn-It-gated.** Delegating to a specialist agent is a tool subject to Earn-It like any other: delegate only when the specialist adds measurable value beyond your own repository context (breadth you lack, or genuinely independent verification); otherwise do the work yourself, where your context yields the highest quality. Not a parallel rule — the application of §3 Earn-It to delegation.
