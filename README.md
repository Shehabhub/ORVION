...
- **Rebuild the engineering environment** (new/fresh machine) → read **`WORKSTATION.md`**, then **double-click `workstation.cmd`** and choose **1 (Prepare)** — it provisions and self-verifies. When it passes, return here and develop.
