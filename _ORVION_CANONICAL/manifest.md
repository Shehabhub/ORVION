...
Last Completed Task: SPEC-038 — migration 8 (CRM core): created customers (with preferred_language_code FK to languages), customer_contact_methods, customer_identity_signals, customer_identity_merges, customer_notes, leads, lead_assignments, lead_interactions; verified on a clean local database and by Migration CI
