...
Last Completed Task: SPEC-039 — migration 9 (suppliers, passengers): created suppliers and passengers, with passengers' nationality_code -> nationalities and passport_issuing_country_code -> countries reference FKs and the passport issue-before-expiry CHECK; verified on a clean local database and by Migration CI
