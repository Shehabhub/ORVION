...
Last Completed Task: SPEC-037 — reference data layer (Option A): added countries, languages, nationalities natural-key reference tables to 31 section 2a + 33, and the create_geo_reference_tables migration; verified on a clean local database
