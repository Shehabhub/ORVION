...
Last Completed Task: SPEC-041 — migration 11 (CRM extension tables): created tasks, complaints, service_requests, conversations, conversation_messages per 31 section 3; tasks owner triple NOT NULL, nullable booking_id/booking_item_id FKs, plain-text codes, archive fields on the three work records, updated_at triggers on four; verified on a clean local database
