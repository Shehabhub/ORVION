...
Last Completed Task: SPEC-035 — migration 6 (finance foundation): created exchange_rates, chart_of_accounts (self-referencing parent_account_id), financial_accounts, with currency_code FKs to currencies, numeric(18,8) rates / numeric(14,2) balances, and updated_at triggers on the two mutable tables; verified on a clean local database and by Migration CI
