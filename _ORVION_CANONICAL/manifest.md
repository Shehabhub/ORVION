...
Last Completed Task: SPEC-051 — added the two deferred catalog_values FKs (tenant_id -> tenants, created_by -> users; restrict/no-action), closing SPEC-024 Finding F2; verified on a clean reset with the 395 seed rows intact and the FK enforced. This was the last deferred DDL before Migration 19
