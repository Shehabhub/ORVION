...
Last Completed Task: SPEC-040 — migration 10 (booking core): created quotations, quotation_items, bookings, booking_items, booking_item_passengers, internal_supplier_links, exchange_rate_adjustments, with exchange_rate/currency/country FKs, non-negative-amount CHECKs, and the passenger unique; verified on a clean local database and by Migration CI
